...
export JENKINS_X_URL='https://dashboard.dev.pauwelslabs.com/pauwels-labs/redact-crypto/main/12'
...
export MINK_IMAGE='274295908850.dkr.ecr.eu-west-1.amazonaws.com/pauwels-labs/redact-crypto:1.3.3'
...
export REPO_NAME='redact-crypto'
